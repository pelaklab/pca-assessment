...
const InstructionsPage: React.FC = () => {
    return (
        <main className="flex h-full flex-col items-start justify-between p-24 w-11/12">
            <h1 className="my-4 text-2xl font-bold text-gray-900">VisCorD Instructions</h1>
            <div className="space-y-4">
                <p>
                    It is recommended that visual field perimetry and at least two additional items
                    from the VisCorD are performed for screening. If a patient fails has a homonymous
                    ...
                    and/or neuropsychologist is indicated. However, the sensitivity and specificity of the
                ...
                <p>
                    <strong>
                        Viewing distance: All tests should be performed at a comfortable viewing
                        distance except for Crowding test, which has specific requirements.
                    </strong>
                </p>
            </div>
                ...
                <table className="table-auto border-collapse border border-black">
                    <thead>
                        <tr>
                            ...
                            <th className="border border-black p-2">Stimulus/Stimuli</th>
                            <th className="border border-black p-2">Instructions</th>
                            <th className="border border-black p-2">Pass or Fail</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td className="border border-black align-top p-1 space-y-4">
                                <p>
                        ...
                        <tr>
                            ...
                            <td className="border border-black align-top p-1 space-y-2">
                                <p>
